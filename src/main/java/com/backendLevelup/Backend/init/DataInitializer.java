...
import java.util.logging.Logger;
    ...
    public class DataInitializer implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
            if (usuarioRepository.count() == 0) { // Solo inicializar si no hay usuarios
                log.info("Base de datos de usuarios vacía. Sembrando datos de prueba");

                // --- 1. Crear Usuarios (ADMIN y USER) ---
                log.info("Creando Usuarios de prueba...");

                Usuario admin = new Usuario();
                admin.setNombre("Admin LevelUp");
                admin.setEmail("admin@levelup.com");
                // Usa el PasswordEncoder para codificar la contraseña
                ...
                cliente.setTieneDescuentoDuoc(false);
                cliente.setRol("USER");
                usuarioRepository.save(cliente);

                log.info("Usuarios creados: admin@levelup.com (admin123) y cliente@duoc.cl (cliente123)");
            }

            // El resto de tu lógica de productos puede ejecutarse si ya no hay productos
            if (categoriaRepository.count() == 0 && productoRepository.count() == 0) {
                ...
                Logitech_G733_Wireless.setPrecio(new BigDecimal("159990"));
                ...
                DualSense_PS5.setPrecio(new BigDecimal("52990"));
                ...
                Estuche_Nintendo_Switch.setPrecio(new BigDecimal("19990"));
                ...
                Asus_ROG_Strix_G18.setDescripcion("Intel Core i9-13650HX / NVIDIA GeForce RTX 4070 12GB / 32GB RAM\n" +
                        "                / 1TB SSD");
                Asus_ROG_Strix_G18.setPrecio(new BigDecimal("2229990"));
                ...
                Acer_Nitro_AN515.setPrecio(new BigDecimal("1099990"));
                Acer_Nitro_AN515.setStock(10);
                Acer_Nitro_AN515.setCategoria(computadores);
                Acer_Nitro_AN515.setImagenUrl("https://levelupgamer-img.s3.us-east-1.amazonaws.com/acer_nitro.png");
                productoRepository.save(Acer_Nitro_AN515);
                ...
                PC_Gamer_R5_RTX_4060.setPrecio(new BigDecimal("1199990"));
                ...
                PlayStation_5.setPrecio(new BigDecimal("536990"));
                PlayStation_5.setStock(10);
                PlayStation_5.setCategoria(consolas);
                PlayStation_5.setImagenUrl("https://levelupgamer-img.s3.us-east-1.amazonaws.com/ps5_slim.png");
                ...
                Xbox_Series_S.setPrecio(new BigDecimal("419990"));
                ...
                Nintendo_Switch_2.setPrecio(new BigDecimal("589990"));
                ...
                Trust_GXT_707R_Resto.setPrecio(new BigDecimal("139990"));
                ...
                Kronos_Hunter_Pro.setDescripcion("Silla Gamer Kronos Hunter Pro Negra y Azul");
                Kronos_Hunter_Pro.setPrecio(new BigDecimal("119990"));
                Kronos_Hunter_Pro.setStock(10);
                Kronos_Hunter_Pro.setCategoria(Sillas_gamer);
                Kronos_Hunter_Pro.setImagenUrl("https://levelupgamer-img.s3.us-east-1.amazonaws.com/kronos_hunter_pro.png");
                productoRepository.save(Kronos_Hunter_Pro);
                ...
                Cougar_Defensor.setPrecio(new BigDecimal("189990"));
                ...
                Logitech_G502_Hero.setPrecio(new BigDecimal("79990"));
                ...
                Razer_DeathAdder.setPrecio(new BigDecimal("89990"));
                ...
                Logitech_G413.setNombre("Logitech G413");
                Logitech_G413.setDescripcion("Teclado Gamer Logitech G413 Mechanical");
                Logitech_G413.setPrecio(new BigDecimal("99990"));
                Logitech_G413.setStock(10);
                Logitech_G413.setCategoria(Mouse_teclado);
                Logitech_G413.setImagenUrl("https://levelupgamer-img.s3.us-east-1.amazonaws.com/logitech_g413.png");
                productoRepository.save(Logitech_G413);
                ...
                HyperX_Fury_S.setPrecio(new BigDecimal("29990"));
                ...
                Logitech_G640.setPrecio(new BigDecimal("29990"));
                ...
                Razer_Gigantus_V2.setPrecio(new BigDecimal("29990"));
                ...
                Polera_HALO.setPrecio(new BigDecimal("19990"));
                ...
                Polera_God_Of_War.setPrecio(new BigDecimal("19990"));
                ...
                Poleron_Legend_of_Zelda.setPrecio(new BigDecimal("39990"));
                ...
                Warhammer_40M.setPrecio(new BigDecimal("89990"));
                ...
                Ajedrez.setPrecio(new BigDecimal("24990"));
                Ajedrez.setStock(10);
                ...
                Shogi.setPrecio(new BigDecimal("59990"));
                Shogi.setStock(10);
